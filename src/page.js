...
// Blog posts: append a "Keep reading" related-posts block so every article links
// to a few siblings. The /blog/ index already links every post (base crawl path);
// this adds internal-link depth + keeps readers moving. Skipped on the index and
// on any post that already ships a static .blog-related block. Future posts inherit it.
if (servicePath.startsWith('/blog/') && servicePath !== '/blog/') {
  const postSlug = servicePath.replace(/^\/blog\//, '').replace(/\/$/, '');
  const blogMain = document.querySelector('main');
  const POST_META = {"automate-invoice-reminders": {"t": "How to Automate Invoice Reminders and Get Paid Faster", "d": "How automated, friendly invoice reminders cut late payments without the awkward chase."}, "monitoring-check-frequency": {"t": "How Often Should Your Website Be Checked? Monitoring Intervals, Explained", "d": "More checks are not always better; how to pick a monitoring interval that catches outages fast without false alarms."}, "automate-google-review-requests": {"t": "How to Automate Google Review Requests Without Nagging Your Customers", "d": "How to automate review requests so more happy customers actually leave one, without breaking Google's rules."}, "your-website-on-a-phone": {"t": "Your Website on a Phone: What Most Small Business Sites Get Wrong", "d": "Why responsive is not the same as usable, and the mobile details that cost you calls."}, "what-uptime-percentages-mean": {"t": "What Uptime Percentages Actually Mean (and Why 99.9% Isn't Always Enough)", "d": "What each uptime nine really allows in downtime, and which level your business needs."}, "automate-appointment-reminders": {"t": "How to Automate Appointment Reminders and Cut Your No-Show Rate", "d": "How automated reminders cut no-shows without sounding like a robot."}, "custom-website-vs-template": {"t": "Custom Website vs. Template: Which One Does Your Business Actually Need?", "d": "When a template is plenty, when a custom build earns its money, and how to tell which you need."}, "what-to-do-when-your-website-goes-down": {"t": "What to Do When Your Website Goes Down: A Small Business Playbook", "d": "A calm, step-by-step plan for the first thirty minutes of an outage."}, "speed-to-lead": {"t": "Speed to Lead: Why the First Five Minutes Decide Whether You Win the Job", "d": "Why fast follow-up beats better follow-up, and how to automate the first reply."}, "how-fast-should-your-website-load": {"t": "How Fast Should Your Website Load? And What Slow Is Costing You", "d": "Real load-time targets and what a slow site quietly costs you."}, "monitoring-third-party-tools": {"t": "The Outage That Isn't Your Fault: Monitoring Your Third-Party Tools", "d": "Your site can be up while a booking widget or checkout quietly fails."}, "ai-chatbots-for-small-business": {"t": "AI Chatbots for Small Business: When They Help and When They Hurt", "d": "When a chatbot earns its keep, and when it backfires."}, "how-small-businesses-use-ai": {"t": "How Small Businesses Are Actually Using AI in 2026", "d": "The real, day-to-day ways small businesses use AI in 2026."}, "monitoring-alert-fatigue": {"t": "Alert Fatigue: Why Too Many Monitoring Alerts Are as Bad as None", "d": "Why too many alerts is as dangerous as none at all."}, "rebuild-vs-fix-your-website": {"t": "When to Rebuild Your Website vs. When to Just Fix It", "d": "How to tell whether to start over or just fix it."}, "signs-your-south-jersey-business-needs-a-new-website": {"t": "7 Signs Your South Jersey Business Needs a New Website", "d": "The clear signs your site is working against you."}, "small-business-website-cost-south-jersey": {"t": "How Much Does a Small Business Website Cost in South Jersey? (2026)", "d": "Real 2026 price ranges and what drives the cost."}, "synthetic-monitoring-vs-uptime": {"t": "Why Your Uptime Check Isn't Enough: The Case for Synthetic Monitoring", "d": "Why a basic uptime check isn't enough."}, "the-outage-you-can-see-coming": {"t": "The One Outage You Can See Coming: SSL and Domain Expiry", "d": "The one outage with a deadline printed on it."}, "what-downtime-actually-costs": {"t": "What an Hour of Downtime Actually Costs a Small Business", "d": "The true cost of an hour of downtime."}, "what-is-an-ai-agent": {"t": "What an AI Agent Actually Is (And Why It Beats Juggling Five AI Tools)", "d": "Why an agent beats juggling five separate AI tools."}, "what-monitoring-does": {"t": "What Monitoring Actually Does (and When Your Business Needs It)", "d": "What monitoring watches, and when you need it."}, "what-to-automate": {"t": "What's Actually Worth Automating in Your Business (And What Isn't)", "d": "What's worth automating, and what isn't."}, "what-your-homepage-needs": {"t": "What Every Small Business Homepage Actually Needs", "d": "The short list every homepage has to nail."}, "when-automations-fail-silently": {"t": "The Silent Failure Problem: When Your Automation Breaks and Nobody Notices", "d": "When automation breaks and nobody notices."}, "why-you-dont-show-up-on-google": {"t": "Why Your Business Doesn't Show Up on Google (And What Actually Fixes It)", "d": "Why most small business sites stay invisible."}, "why-your-website-isnt-converting": {"t": "Why Your Website Gets Visitors But Not Customers", "d": "Why visitors leave without becoming customers."}, "writing-ai-prompts-for-business": {"t": "How to Write AI Prompts That Actually Get Consistent Results", "d": "How to get consistent results from AI prompts."}};
  const POST_REL = {"automate-invoice-reminders": ["automate-appointment-reminders", "what-to-automate", "when-automations-fail-silently"], "monitoring-check-frequency": ["what-downtime-actually-costs", "monitoring-alert-fatigue", "synthetic-monitoring-vs-uptime"], "automate-google-review-requests": ["why-you-dont-show-up-on-google", "speed-to-lead", "automate-appointment-reminders"], "your-website-on-a-phone": ["how-fast-should-your-website-load", "why-your-website-isnt-converting", "what-your-homepage-needs"], "what-uptime-percentages-mean": ["what-downtime-actually-costs", "what-monitoring-does", "synthetic-monitoring-vs-uptime"], "automate-appointment-reminders": ["speed-to-lead", "automate-invoice-reminders", "when-automations-fail-silently"], "custom-website-vs-template": ["small-business-website-cost-south-jersey", "rebuild-vs-fix-your-website", "what-your-homepage-needs"], "what-to-do-when-your-website-goes-down": ["what-monitoring-does", "what-downtime-actually-costs", "synthetic-monitoring-vs-uptime"], "speed-to-lead": ["ai-chatbots-for-small-business", "when-automations-fail-silently", "automate-appointment-reminders"], "how-fast-should-your-website-load": ["why-your-website-isnt-converting", "why-you-dont-show-up-on-google", "your-website-on-a-phone"], "monitoring-third-party-tools": ["synthetic-monitoring-vs-uptime", "what-monitoring-does", "the-outage-you-can-see-coming"], "ai-chatbots-for-small-business": ["speed-to-lead", "what-to-automate", "when-automations-fail-silently"], "how-small-businesses-use-ai": ["what-to-automate", "ai-chatbots-for-small-business", "what-is-an-ai-agent"], "monitoring-alert-fatigue": ["what-monitoring-does", "synthetic-monitoring-vs-uptime", "monitoring-check-frequency"], "rebuild-vs-fix-your-website": ["signs-your-south-jersey-business-needs-a-new-website", "small-business-website-cost-south-jersey", "custom-website-vs-template"], "signs-your-south-jersey-business-needs-a-new-website": ["rebuild-vs-fix-your-website", "why-your-website-isnt-converting", "small-business-website-cost-south-jersey"], "small-business-website-cost-south-jersey": ["rebuild-vs-fix-your-website", "signs-your-south-jersey-business-needs-a-new-website", "custom-website-vs-template"], "synthetic-monitoring-vs-uptime": ["what-monitoring-does", "the-outage-you-can-see-coming", "monitoring-alert-fatigue"], "the-outage-you-can-see-coming": ["what-monitoring-does", "monitoring-third-party-tools", "synthetic-monitoring-vs-uptime"], "what-downtime-actually-costs": ["what-monitoring-does", "monitoring-check-frequency", "synthetic-monitoring-vs-uptime"], "what-is-an-ai-agent": ["what-to-automate", "how-small-businesses-use-ai", "writing-ai-prompts-for-business"], "what-monitoring-does": ["synthetic-monitoring-vs-uptime", "what-uptime-percentages-mean", "what-downtime-actually-costs"], "what-to-automate": ["when-automations-fail-silently", "automate-appointment-reminders", "automate-invoice-reminders"], "what-your-homepage-needs": ["why-your-website-isnt-converting", "signs-your-south-jersey-business-needs-a-new-website", "your-website-on-a-phone"], "when-automations-fail-silently": ["what-to-automate", "what-monitoring-does", "how-small-businesses-use-ai"], "why-you-dont-show-up-on-google": ["why-your-website-isnt-converting", "signs-your-south-jersey-business-needs-a-new-website", "automate-google-review-requests"], "why-your-website-isnt-converting": ["what-your-homepage-needs", "why-you-dont-show-up-on-google", "how-fast-should-your-website-load"], "writing-ai-prompts-for-business": ["what-is-an-ai-agent", "how-small-businesses-use-ai", "what-to-automate"]};
  const relList = POST_REL[postSlug];
  if (postSlug && blogMain && relList && !document.querySelector('.blog-related')) {
    const cards = relList.map((r) => {
      const m = POST_META[r];
      return m ? `<a class="related-link" href="/blog/${r}/"><div><h3>${m.t}</h3><p>${m.d}</p></div><span class="related-arrow" aria-hidden="true">&rarr;</span></a>` : '';
    }).join('');
    const sec = document.createElement('section');
    sec.className = 'section blog-related';
    sec.setAttribute('aria-label', 'Keep reading');
    sec.innerHTML = `<div class="container"><div class="section-heading"><h2>Keep <em>reading</em></h2></div><div class="related-links">${cards}</div></div>`;
    blogMain.appendChild(sec);
  }
}
