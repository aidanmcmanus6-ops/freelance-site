  ...
  build: {
    rollupOptions: {
      input: {
        ...
        blogDowntime: resolve(__dirname, 'blog/what-downtime-actually-costs/index.html'),
        blogGoogleSearch: resolve(__dirname, 'blog/why-you-dont-show-up-on-google/index.html'),
        blogAiPrompts: resolve(__dirname, 'blog/writing-ai-prompts-for-business/index.html'),
      },
    },
  },
});
